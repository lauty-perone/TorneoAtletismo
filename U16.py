...
#PRUEBAS DE PISTA
series(filtrar_100Metros(masculino),"100 Metros Masculino U16")
series(filtrar_100Metros(femenino),"100 Metros Femenino U16")

series(filtrar_400Metros(masculino),"400 Metros Masculino U16")
series(filtrar_400Metros(femenino),"400 Metros Femenino U16")

series(filtrar_1500Metros(masculino),"1500 Metros Masculino U16", 15)
series(filtrar_1500Metros(femenino),"1500 Metros Femenino U16",15)

series(filtrar_3000Metros(masculino),"3000 Metros Masculino U16",20)
series(filtrar_3000Metros(femenino),"3000 Metros Femenino U16",20)

series(filtrar_vallas(masculino),"110 con Vallas Masculino U16")
series(filtrar_vallas(femenino),"100 con Vallas Femenino U16")
...
guardar_pruebas_de_campo(filtrar_largo(masculino),'Inscriptos Largo Masculino U16.csv')
guardar_pruebas_de_campo(filtrar_largo(femenino),'Inscriptos Largo Femenino U16.csv')

guardar_pruebas_de_campo(filtrar_garrocha(masculino),'Inscriptos Garrocha Masculino U16.csv')
guardar_pruebas_de_campo(filtrar_garrocha(femenino),'Inscriptos Garrocha Femenino U16.csv')

guardar_pruebas_de_campo(filtrar_martillo(masculino),'Inscriptos Martillo Masculino U16.csv')
guardar_pruebas_de_campo(filtrar_martillo(femenino),'Inscriptos Martillo Femenino U16.csv')

guardar_pruebas_de_campo(filtrar_bala(masculino),'Inscriptos Bala Masculino U16.csv')
guardar_pruebas_de_campo(filtrar_bala(femenino),'Inscriptos Bala Femenino U16.csv')

guardar_pruebas_de_campo(filtrar_jabalina(masculino),'Inscriptos Jabalina Masculino U16.csv')
guardar_pruebas_de_campo(filtrar_jabalina(femenino),'Inscriptos Jabalina Femenino U16.csv')
